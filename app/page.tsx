                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <div className="bg-[#1c1c1c] rounded-3xl p-8 border border-white/5 flex flex-col hover:border-[#DBC278]/30 transition-all">
                            ...
                            <Link href="https://wa.me/5543998662506?text=Ol%C3%A1!%20Tenho%20interesse%20no%20Plano%20Mensal%20(R$%2049,90/m%C3%AAs).%20Gostaria%20de%20entender%20como%20funciona%20a%20parte%20de%20Agendamento%20e%20Gest%C3%A3o%20para%20come%C3%A7ar%20o%20quanto%20antes.%20Pode%20me%20ajudar?" target="_blank">
                                <Button variant="outline" className="w-full border-zinc-700 hover:bg-zinc-800 text-white">Assinar Mensal</Button>
                            </Link>
                        </div>
                        ...
                        <div className="bg-[#1c1c1c] rounded-3xl p-8 border border-[#DBC278] relative transform md:-translate-y-4 shadow-2xl shadow-[#DBC278]/10 flex flex-col">
                            ...
                            <Link href="https://wa.me/5543998662506?text=Ol%C3%A1!%20Vi%20que%20o%20Plano%20Anual%20%C3%A9%20a%20melhor%20op%C3%A7%C3%A3o%20econ%C3%B4mica%20(R$%20499,90/ano).%20Gostaria%20de%20aproveitar%20o%20desconto%20de%202%20meses%20gr%C3%A1tis%20e%20saber%20mais%20sobre%20a%20Orienta%C3%A7%C3%A3o%20no%20Faturamento.%20Como%20fa%C3%A7o%20para%20assinar?" target="_blank">
                                <Button className="w-full bg-[#DBC278] hover:bg-[#c9b06b] text-black font-bold h-12">Assinar Anual</Button>
                            </Link>
                        </div>
                        ...
                        <div className="bg-[#1c1c1c] rounded-3xl p-8 border border-white/5 flex flex-col hover:border-[#DBC278]/30 transition-all">
                            ...
                            <Link href="https://wa.me/5543998662506?text=Ol%C3%A1!%20Gostaria%20de%20assinar%20o%20Plano%20Semestral%20(R$%20269,90/semestre).%20Achei%20o%20equil%C3%ADbrio%20ideal%20para%20o%20meu%20neg%C3%B3cio%20e%20quero%20aproveitar%20o%20desconto%20de%2010%25.%20Quais%20s%C3%A3o%20os%20pr%C3%B3ximos%20passos?" target="_blank">
                                <Button variant="outline" className="w-full border-zinc-700 hover:bg-zinc-800 text-white">Assinar Semestral</Button>
                            </Link>
                        </div>
                    </div>
