    ...
    const timeSlots = useMemo(() => {
        ...
        while (isBefore(currentTime, endTime)) {
            ...
            if (lunchStartTime && lunchEndTime) {
                // If slot start is >= lunch start AND < lunch end, skip it
                // e.g. Lunch 12:00 - 13:00. Slot 12:00 -> Skip. Slot 12:30 -> Skip. Slot 13:00 -> Include.
        ...
        return slots
    }, [selectedDate, client, recurrings])
