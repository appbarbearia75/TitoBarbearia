...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-8 max-w-4xl pb-20">
                        ...
                        <CardContent className="space-y-8">
                            <div className="grid grid-cols-1 gap-8">
                                <ImageUpload
                                    ...
                                    onUpload={(url) => handleUpload('avatar_url', url)}
                                    aspectRatio="square"
                                />
                                <ImageUpload
                                    label="Foto de Capa"
                                    ...
                                    onUpload={(url) => handleUpload('cover_url', url)}
                                    aspectRatio="video"
                                />
                            </div>
                        </CardContent>
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-zinc-950/80 backdrop-blur-sm border-t border-zinc-800 flex justify-end md:justify-center z-40">
                <Button onClick={handleSave} className="bg-yellow-500 hover:bg-yellow-400 text-black font-bold w-full md:w-auto md:min-w-[200px]" disabled={loading}>
                    {loading ? "Salvando..." : (
                        <>
...
function TeamManager({ slug }: { slug: string }) {
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-4 border p-4 rounded-lg border-zinc-800 bg-zinc-950/50">
            ...
            <div className="space-y-2">
                ...
                {barbers.length === 0 ? (
                    ...
                    <div className="grid gap-2">
                        {barbers.map(barber => (
                            <div key={barber.id} className="flex items-center justify-between p-3 bg-zinc-800 rounded-lg">
