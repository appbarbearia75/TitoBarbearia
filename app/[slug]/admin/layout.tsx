...
import { Calendar, Settings, Scissors, BarChart, LogOut, LayoutDashboard, Users, Menu, X } from "lucide-react"
...
export default function TenantAdminLayout({
    ...
    return (
        <div className="min-h-screen bg-black flex font-sans text-white">
            {/* Sidebar */}
            <aside className="w-64 border-r border-white/10 bg-zinc-900/50 p-6 flex flex-col hidden md:flex">
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 z-50 bg-black/80 md:hidden animate-in fade-in">
                    <div className="fixed inset-y-0 left-0 w-64 bg-zinc-900 border-r border-white/10 p-6 flex flex-col animate-in slide-in-from-left">
