            ...
            <div className="w-full max-w-sm">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex h-12 w-full items-center rounded-md border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-within:border-yellow-500 focus-within:ring-yellow-500/20">
                            <span className="text-zinc-400 text-base font-medium select-none whitespace-nowrap">agendae.com/</span>
                            <input
                                name="slug"
                    ...
                    <Button
                        type="submit"
                        className="w-full h-12 bg-yellow-500 hover:bg-yellow-400 text-black font-bold text-base rounded-xl mt-2"
                        disabled={loading}
                    >
                ...
                <p className="text-center mt-8 text-xs text-zinc-600">
                    Já tem uma conta? <Link href="/login" className="text-yellow-500 hover:underline">Fazer Login</Link>
                </p>
            </div>
        </div>
    )
